...
GCP_PROJECT = os.environ.get('GOOGLE_CLOUD_PROJECT', os.environ.get('GOOGLE_PROJECT') or 'infinity-x-one-systems')
...
def synthesize_text_to_gcs(text: str, bucket_name: str, object_name: str) -> Optional[str]:
...
def place_call_twilio(to_number: str, twiml: Optional[str] = None, play_url: Optional[str] = None, twilio_creds: Optional[dict] = None):
    ...
    if play_url:
        ...
        data['Twiml'] = '<Response><Say voice="alice">This is an automated call from InfinityXOne systems.</Say></Response>'

...
from services.real_estate_intelligence.autonomous.autonomy_pipeline import \
    run_full_pipeline
...
def main():
    ...
    sample = [
        {"id": 1, "address": "123 Main St", "description": "vacant foreclosure auction"}
    ]
    res = run_full_pipeline(
        sample, args.to, from_number=args.from_, dry_run=args.dry_run
    )
